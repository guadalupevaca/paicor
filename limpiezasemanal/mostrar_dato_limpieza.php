...
if (isset($_POST["generar_pdf"])) {
    ...
    $productos = array(
        'bolsas_consorcio', 'lavandina', 'detergente', 'desengrasante',
        'desinfectante', 'valerinas', 'alcohol', 'escobillon', 'secador_pisos',
        'trapo_piso', 'baldes', 'esponja', 'fosforos', 'otros_productos'
    );
    ...
    $dompdf->stream('datos_limpieza.pdf', array('Attachment' => 0));
    exit;
}
...
<head>
    ...
    <title>Mostrar Datos de Limpieza</title>
</head>
<body>
    <header>
        <h1>Mostrar Datos de Limpieza</h1>
    </header>
