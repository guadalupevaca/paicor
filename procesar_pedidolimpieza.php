...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pedidos_limpieza (nombre, fecha_pedido, bolsas_consorcio, lavandina, detergente, desengrasante, desinfectante, valerinas, alcohol, escobillon, secador_pisos, trapo_piso, baldes, esponja, fosforos, otros_productos)
            VALUES ('$nombre','$fechaPedido', '$bolsasConsorcio', '$lavandina', '$detergente', '$desengrasante', '$desinfectante', '$valerinas', '$alcohol', '$escobillon', '$secadorPisos', '$trapoPiso', '$baldes', '$esponja', '$fosforos', '$otrosProductos')";
